  ...
  return (
    <>
      ...
      >
            ...
            <div className="h-full flex flex-col items-center justify-center text-center space-y-6">
               ...
               <div>
                 ...
                 <p className="text-sm text-slate-400 mt-2 max-w-[220px] leading-relaxed">
                   Start exploring courses and tap star icon to add them to your plan.
                 </p>
               </div>
            </div>
          ) : (
        ...
        <div className="p-6 border-t border-white/10 bg-black/20 backdrop-blur-md space-y-4 shrink-0 z-10">
