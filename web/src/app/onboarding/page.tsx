...
import topbar from "../page.module.css";           // <-- reuse EXACT top bar styles
...
export default function OnboardingPage() {
  ...
  // options (adjust to your catalog if desired)
  ...
  return (
    <div className={styles.page}>
      {/* EXACT top bar reused from landing page */}
      <div className={topbar.topBar}>
        <div className={topbar.topBarInner}>
          {/* if your landing page has a logo element, reuse it here */}
                ...
                <div>
                  ...
                  <div className={styles.reviewList}>
                    ...
                    <Row
                      ...
                      value={
                        languageName
                          ? `${languageName} ${languageLevel} (${languageIntent})`
                          : "—"
                      }
                    />
                  </div>
...
function Row({ label, value }: { label: string; value: string }) {
  return (
    <div className="row" style={{
      ...
      borderRadius: 12,
      padding: "12px 14px",
      fontFamily: "Proxima Nova, proxima-nova, system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial, sans-serif",
    }}>
...
function DebugPrefs() {
  ...
  return (
    <details className={styles.debug}>
      <summary>Debug: current saved prefs</summary>
      <pre className={styles.debugPre}>{json}</pre>
    </details>
  );
}
